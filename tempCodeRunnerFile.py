...
df_antpat = pd.read_excel('Coverage Map - Measurement Based PL Model (n77)\Antenna_Pattern.xlsx')
df_cellparam = pd.read_excel('Coverage Map - Measurement Based PL Model (n77)\Cell_Parameter.xlsx')
